...
OBJ_NOUNS = [
    ...
    # Warehouse / workplace extensions
    "pallet", "forklift", "scanner", "cart", "bin", "shelf", "ladder",
    "hard hat", "safety vest", "gloves", "package", "document", "handle",
    "none",
]
SOCIAL_TAX = [
...
# Short, distinctive CLIP text prompts — one phrase per label.
# Kept brief so similar labels stay maximally separated in embedding space.
_BODY_STATE_PHRASES = {
    "idle_stand":       "standing still upright",
    "idle_sit":         "sitting idle",
    "walk":             "walking",
    "walk_loaded":      "walking while carrying a load",
    "run":              "running fast",
    "bend":             "bending forward at the waist",
    "squat":            "squatting low",
    "kneel":            "kneeling on one knee",
    "reach_overhead":   "reaching arms overhead",
    "reach_low":        "reaching down to the floor",
    "twist":            "twisting torso sideways",
    "crouch_sustained": "crouching in a sustained low posture",
    "climb":            "climbing a ladder",
    "fall":             "falling to the ground",
    "recover_balance":  "stumbling and regaining balance",
}
_OBJ_VERB_PHRASES = {
    "reach":   "reaching toward an object",
    "grasp":   "gripping an object with hands",
    "lift":    "lifting an object upward",
    "lower":   "lowering an object down",
    "carry":   "carrying an object while moving",
    "place":   "placing an object on a surface",
    "push":    "pushing an object away",
    "pull":    "pulling an object closer",
    "drag":    "dragging an object across the floor",
    "stack":   "stacking objects on top of each other",
    "unstack": "removing objects from a stack",
    "pack":    "packing items into a container",
    "unpack":  "removing items from a container",
    "scan":    "scanning a barcode",
    "inspect": "inspecting an object closely",
    "operate": "operating a machine or control",
...
_OBJ_NOUN_PHRASES = {
    ...
    # Warehouse / workplace extensions
    "pallet":           "a wooden pallet",
    "forklift":         "a forklift",
    "scanner":          "a handheld barcode scanner",
    "cart":             "a wheeled cart",
    "bin":              "a storage bin or tote",
    "shelf":            "a storage shelf",
    "ladder":           "a ladder",
    "hard hat":         "a hard hat",
    "safety vest":      "a high-visibility safety vest",
    "gloves":           "work gloves",
...
_SOCIAL_PHRASES = {
    ...
    "co_manipulate":    "jointly holding an object with another person",
    "gesture_instruct": "gesturing to instruct someone",
...
_SAFETY_PHRASES = {
    ...
    "ppe_doff":         "removing safety equipment",
    "near_miss":        "a near-miss incident",
    "hazard_response":  "responding to a hazard",
    "fall":             "falling and hitting the ground",
}
